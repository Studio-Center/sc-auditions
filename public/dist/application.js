...
var ApplicationConfiguration = function () {
  ...
  var applicationModuleVendorDependencies = ['ngRoute', 'ngResource', 'ngCookies', 'ngAnimate', 'ngTouch', 'ngSanitize', 'ui.router', 'ui.bootstrap', 'ui.utils', 'angularFileUpload', 'ngAudio', 'ui.bootstrap.datetimepicker', 'rt.encodeuri', 'angularMoment', 'textAngular', 'btford.socket-io', 'ngCookies', 'base64', 'ngSanitize', 'ui.tinymce'];
...
//moment.tz.setDefault('America/New_York');;'use strict';
...
angular.module('clients').run(['Menus', 'Authentication', function (Menus, Authentication) {
  // Set top bar menu items
  Menus.addMenuItem('topbar', 'Clients', 'clients', 'dropdown', '/clients/projects', false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator', 'talent director', 'client', 'client-client'], 1);
...
//Setting up route
angular.module('clients').config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
  // Projects state routing
  $stateProvider.state('clientProjectsList', {
...
//Setting up route
angular.module('logs').config(['$stateProvider', function ($stateProvider) {
  // Logs state routing
  $stateProvider.state('listLogs', {
    url: '/logs',
...
// Configuring the Articles module
angular.module('projects').run(['Menus', 'Authentication', function (Menus, Authentication) {
  // Set top bar menu items
  Menus.addMenuItem('topbar', 'Projects', 'projects', 'dropdown', '/projects(/create)?', false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator', 'talent director'], 0);
  Menus.addSubMenuItem('topbar', 'projects', 'New', 'projects/create', false, false, ['admin', 'production coordinator']);
  Menus.addSubMenuItem('topbar', 'projects', 'Browse', 'projects', false, false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator', 'talent director']);
}]);
;
'use strict';

//Setting up route
angular.module('projects').config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
  // Projects state routing
...
angular.module('reports').run(['Menus', function (Menus) {
  // Set top bar menu items
  Menus.addMenuItem('topbar', 'Reports', 'reports', 'dropdown', '/reports(/create)?', false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'talent director'], 3);
  ...
  Menus.addSubMenuItem('topbar', 'reports', 'Assigned Producer Report', 'reports/assigned-producer');
...
// Configuring the Articles module
angular.module('talents').run(['Menus', 'Authentication', function (Menus, Authentication) {
  // Set top bar menu items
  Menus.addMenuItem('topbar', 'Talent', 'talents', 'dropdown', '/talents(/create)?', false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator', 'talent director'], 4);
  Menus.addSubMenuItem('topbar', 'talents', 'Browse', 'talents', false, false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator', 'talent director']);
  Menus.addSubMenuItem('topbar', 'talents', 'New', 'talents/create', false, false, ['admin', 'talent director', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator']);
}]);
;
'use strict';

//Setting up route
angular.module('talents').config(['$stateProvider', function ($stateProvider) {
  // Talents state routing
  $stateProvider.state('listTalents', {
    url: '/talents',
...
// Configuring the Articles module
angular.module('tools').run(['Menus', function (Menus) {
  // Set top bar menu items
  Menus.addMenuItem('topbar', 'Tools', 'tools', 'dropdown', '/tools(/create)?', false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator'], 2);
...
//Setting up route
angular.module('tools').config(['$stateProvider', function ($stateProvider) {
  // Tools state routing
  $stateProvider.state('listTools', {
    url: '/tools',
...
// Configuring the Articles module
angular.module('typecasts').run(['Menus', 'Authentication', function (Menus, Authentication) {
  // Set top bar menu items
...
//Setting up route
angular.module('typecasts').config(['$stateProvider', function ($stateProvider) {
  // Typecasts state routing
  $stateProvider.state('listTypecasts', {
    url: '/typecasts',
...
angular.module('users').run(['Menus', 'Authentication', function (Menus, Authentication) {
  // Set top bar menu items
  Menus.addMenuItem('topbar', 'Users', 'users', 'dropdown', '/usersedit(/create)?', false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator'], 6);
  Menus.addSubMenuItem('topbar', 'users', 'Browse', 'usersedit', false, false, ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator']);
...
// Projects controller
angular.module('clients').controller('BookModalController', ['$scope', '$stateParams', '$location', 'Authentication', 'Projects', '$upload', 'ngAudio', '$http', '$uibModalInstance', 'data', '$rootScope', 'IS_NOT_MOBILE', function ($scope, $stateParams, $location, Authentication, Projects, $upload, ngAudio, $http, $uibModalInstance, data, $rootScope, IS_NOT_MOBILE) {
  ...
  var loadAuditions = function loadAuditions() {
  ...
  var saveAudition = function saveAudition(audition) {
  ...
  $scope.cancel = function () {
    if (_typeof($scope.audio) === 'object') {
      $scope.audio.stop();
    }
    $uibModalInstance.dismiss('cancel');
  };
  $scope.verifyAudioSingle = function (audition) {
    if (_typeof(audition.file) === 'object') {
      return true;
    }
    return false;
  };
  $scope.verifyAudio = function (key) {
    if (_typeof($scope.project.auditions[key]) === 'object') {
      if (_typeof($scope.project.auditions[key].file) === 'object') {
        return true;
      }
    }
    return false;
  ...
  $scope.playAudio = function (key, filename, fileDir) {
    ...
    if (IS_NOT_MOBILE) {
      ...
      if (key !== $scope.lastAudioID && _typeof($scope.audio) === 'object') {
        $scope.audio.unbind();
        $scope.audio.stop();
      }
      if (_typeof($scope.audio) === 'object' && key === $scope.lastAudioID && $scope.audioStatus === 1 && _typeof($scope.audio) === 'object') {
        $scope.audio.pause();
        $scope.audioStatus = 0;
        //console.log('pause');
        return;
      }
      if (_typeof($scope.audio) === 'object' && key === $scope.lastAudioID && $scope.audioStatus === 0 && _typeof($scope.audio) === 'object') {
        $scope.audio.play();
        $scope.audioStatus = 1;
  ...
  $scope.playAudioSingle = function (key, audition, fileDir) {
    ...
    if (IS_NOT_MOBILE) {
      ...
      if (_typeof($scope.audio) === 'object' && key === $scope.lastAudioID && $scope.audioStatus === 1) {
        $scope.audio.pause();
        $scope.audioStatus = 0;
        return;
      }
      if (_typeof($scope.audio) === 'object' && key === $scope.lastAudioID && $scope.audioStatus === 0) {
        $scope.audio.play();
        $scope.audioStatus = 1;
...
// Projects controller
angular.module('clients').controller('ClientsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Projects', '$upload', 'ngAudio', 'ngAudioGlobals', '$http', '$uibModal', '$rootScope', 'Socket', '$cookies', '$window', 'IS_NOT_MOBILE', function ($scope, $stateParams, $location, Authentication, Projects, $upload, ngAudio, ngAudioGlobals, $http, $uibModal, $rootScope, Socket, $cookies, $window, IS_NOT_MOBILE) {
  $scope.authentication = Authentication;
  ...
  $scope.updateNoRefresh = function () {
    ...
    $http.post('/projects/updateNoRefresh', {
      ...
      Socket.emit('projectUpdateRequest', {
        id: data._id
      });
      // update local project document
      $scope.project = angular.extend($scope.project, data);
  ...
  $rootScope.$on('refreshProject', function (event, args) {
  ...
  $scope.leadFormPop = function () {
    if (_typeof(Authentication.user) === 'object') {
  ...
  var performUploadTempScript = function performUploadTempScript(file, i, $files) {
    $scope.upload = $upload.upload({
      url: 'projects/uploads/script/temp',
  ...
  var bookedAudsDL = function bookedAudsDL(bookedAuds) {
  ...
  var audsSelDL = function audsSelDL(selectedAuds) {
  ...
  $scope.verifyAudio = function (key) {
    var auditions = $scope.project.auditions;
    if (_typeof(auditions[key]) === 'object') {
      if (_typeof(auditions[key].file) === 'object') {
        return true;
      }
    }
    return false;
...
;
'use strict';
angular.module('core').controller('HeaderController', ['$scope', 'Authentication', 'Menus', '$window', '$rootScope', '$location', 'Socket', function ($scope, Authentication, Menus, $window, $rootScope, $location, Socket) {
  $scope.authentication = Authentication;
...
// Logs controller
angular.module('logs').controller('LogsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Logs', '$http', function ($scope, $stateParams, $location, Authentication, Logs, $http) {
  $scope.authentication = Authentication;
...
angular.module('projects').controller('ProjectsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Projects', '$upload', 'ngAudio', '$http', '$uibModal', '$rootScope', 'Socket', '$cookies', 'moment', '$window', 'Talents', 'IS_NOT_MOBILE', function ($scope, $stateParams, $location, Authentication, Projects, $upload, ngAudio, $http, $uibModal, $rootScope, Socket, $cookies, moment, $window, Talents, IS_NOT_MOBILE) {
  ...
  // create user modals
  $scope.createClient = function (_owner) {
    var modalInstance = $uibModal.open({
      animation: true,
  ...
  $scope.isOwner = function () {
    ...
    if (_typeof(project.user) === 'object') {
  ...
  $scope.checkClientClientUsers = function (userId) {
    var project = $scope.project;
    if (_typeof(project.clientClient) === 'object') {
      var limit = project.clientClient.length,
        i = 0;
      if (_typeof(project) === 'object') {
        for (i = 0; i < limit; ++i) {
  ...
  $scope.checkClientUsers = function (userId) {
    var project = $scope.project;
    if (_typeof(project.client) === 'object') {
  ...
  $scope.checkTeam = function (userId) {
    var project = $scope.project;
    if (_typeof(project.team) === 'object') {
  ...
  $scope.checkTalent = function (talentId) {
    var project = $scope.project;
    if (_typeof(project.talent) === 'object') {
  ...
  $scope.dupCheck = function () {
    if ($stateParams.projectId) {
      $http.get('/projects/' + $stateParams.projectId, {}).success(function (data, status, headers, config) {
  ...
  if (_typeof($scope.watchersObj.procCnt) !== 'object') {
  ...
  if (_typeof($scope.watchersObj['newProject.estimatedCompletionDate']) !== 'object') {
  ...
  if (_typeof($scope.watchersObj.project) !== 'object') {
    $scope.watchersObj.project = $scope.$watchCollection('project', function (val) {
      if (_typeof($scope.project) === 'object') {
        if (_typeof($scope.watchersObj.project.auditions) !== 'object') {
        ...
        if (_typeof($scope.watchersObj.project.referenceFiles) !== 'object') {
          $scope.watchersObj.project.referenceFiles = $scope.$watchCollection('project.referenceFiles', function () {
            if (_typeof($scope.project.referenceFiles) === 'object') {
        ...
        // update progress bar
        if (_typeof($scope.watchersObj.project.phases) !== 'object') {
  ...
  var performScriptUpload = function performScriptUpload(file, i, $files) {
    var project = $scope.project;
    $scope.upload = $upload.upload({
      url: 'projects/uploads/script',
      //upload.php script, node.js route, or servlet url
      //method: 'POST' or 'PUT',
      data: {
        projectId: project._id
  ...
  var performUploadReferenceFile = function performUploadReferenceFile(file, i, $files) {
    var project = $scope.project;
    $scope.upload = $upload.upload({
      url: 'projects/uploads/referenceFile',
      //upload.php script, node.js route, or servlet url
      data: {
        projectId: project._id
      },
  ...
  var performUploadTempReferenceFile = function performUploadTempReferenceFile(file, i, $files) {
    $scope.upload = $upload.upload({
      url: 'projects/uploads/referenceFile/temp',
      //upload.php script, node.js route, or servlet url
      data: {
        project: $scope.project
      },
  ...
  var performUploadTempAuditionFile = function performUploadTempAuditionFile(file, i, $files) {
    $scope.upload = $upload.upload({
      url: 'projects/uploads/audition/temp',
      //upload.php script, node.js route, or servlet url
      data: {
        project: $scope.project
      },
...
// Reports controller
angular.module('reports').controller('ReportsController', ['$scope', '$stateParams', '$location', 'Authentication', '$http', function ($scope, $stateParams, $location, Authentication, $http) {
  $scope.authentication = Authentication;
  $scope.dateFilter = '';
  $scope.sysstats = {};
  $scope.intervalID = '';
  ...
  $scope.systemInfo = function () {
    // query server
    $http.post('/reports/systemStats', {}).success(function (data, status, headers, config) {
      $scope.sysstats = data;
    });
...
// Talents controller
angular.module('talents').controller('TalentsModalController', ['$scope', '$stateParams', '$location', 'Authentication', 'Talents', '$http', '$uibModalInstance', '$rootScope', 'Socket', function ($scope, $stateParams, $location, Authentication, Talents, $http, $uibModalInstance, $rootScope, Socket) {
  $scope.authentication = Authentication;
...
// Talents controller
angular.module('talents').controller('TalentsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Talents', 'UsersFind', '$http', '$rootScope', 'Socket', function ($scope, $stateParams, $location, Authentication, Talents, UsersFind, $http, $rootScope, Socket) {
  $scope.authentication = Authentication;
  ...
  $scope.sendTalentEmail = function (talent, project) {
    ...
    $http.get('/projects/' + project._id, {}).success(function (data, status, headers, config) {
...
// Tools controller
angular.module('tools').controller('ToolsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Talents', '$http', 'Socket', 'Projects', '$upload', function ($scope, $stateParams, $location, Authentication, Talents, $http, Socket, Projects, $upload) {
  $scope.authentication = Authentication;
  ...
  $scope.gatherTalentsToCall = function () {
    $http.post('/tools/gatherTalentsToCall').success(function (data, status, headers, config) {
      $scope.callProjects = data;
    });
  };
  // gather talents
  $scope.gatherTalentsMessagesLeft = function () {
    $http.post('/tools/gatherTalentsMessagesLeft').success(function (data, status, headers, config) {
      $scope.messagedTalents = data;
    });
  };
  $scope.gatherTalentsAlreadyScheduled = function () {
    $http.post('/tools/gatherTalentsAlreadyScheduled').success(function (data, status, headers, config) {
      $scope.alreadyScheduledTalents = data;
    });
  };
  $scope.gatherEmailedTalent = function () {
    $http.post('/tools/gatherEmailedTalent').success(function (data, status, headers, config) {
  ...
  $scope.performUploadTalentFile = function (file, i, $files) {
    $scope.upload = $upload.upload({
      ...
      $scope.alerts.push({
        type: data.status,
        msg: 'Updated talents ' + data.updatedTalents + ' - New talents ' + data.newTalents + ' - Failed talents ' + data.failed.length
      });
    });
  };
  $scope.processGoogleSheet = function () {
    ...
    if ($scope.google.spreadsheetkey !== '') {
      $http.post('/tools/processGoogleSheet', {
        ...
        $scope.alerts.push({
          type: 'success',
          msg: 'All talents have been imported into the database.'
        });
      });
    } else {
      $scope.alerts.push({
        type: 'danger',
        msg: 'Pelase make sure that you have populated the field!'
      });
    }
  };
  ...
  $scope.findNewProjects = function () {
    $http.post('/tools/listNewprojects', {}).success(function (data, status, headers, config) {
...
angular.module('typecasts').controller('TypecastsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Typecasts', 'Socket', function ($scope, $stateParams, $location, Authentication, Typecasts, Socket) {
  $scope.authentication = Authentication;
  ...
  $scope.permitAdminDirector = function () {
    var allowRoles = ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'talent director'],
      i = 0,
      j = 0,
      authRoles = Authentication.user.roles,
      limit = authRoles.length;
...
;
'use strict';
angular.module('users').controller('SettingsController', ['$scope', '$http', '$location', 'Users', 'Authentication', '$base64', function ($scope, $http, $location, Users, Authentication, $base64) {
  $scope.user = Authentication.user;

  // custom arrays
  $scope.roleOpts = ['user', 'admin', 'producer/auditions director', 'auditions director', 'audio intern', 'talent', 'talent director', 'client', 'agency'];
  $scope.permitEveryOneButClients = function () {
    var allowRoles = ['admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator', 'talent director'];
...
// Users controller
angular.module('users').controller('UsersListController', ['$scope', '$stateParams', '$location', 'Authentication', 'UsersEdit', 'UsersFind', '$http', '$rootScope', function ($scope, $stateParams, $location, Authentication, UsersEdit, UsersFind, $http, $rootScope) {
  $scope.authentication = Authentication;
  ...
  $scope.findFilter = function (selUserLevel) {
    $scope.users = UsersFind.query({
      userLevel: selUserLevel
    });
  };

  // refresh list of users on refresh emit
  $rootScope.$on('refresh', $scope.find());
  $rootScope.$on('refreshListFilter', function (event, args) {
...
// Users controller
angular.module('users').controller('UsersModalController', ['$scope', '$stateParams', '$location', 'Authentication', 'UsersEdit', 'UsersFind', '$http', '$uibModalInstance', '$rootScope', 'owner', function ($scope, $stateParams, $location, Authentication, UsersEdit, UsersFind, $http, $uibModalInstance, $rootScope, owner) {
  $scope.authentication = Authentication;
  $scope.roleOpts = ['client', 'client-client'];
  $scope.owner = owner;
  ...
  $scope.createModel = function () {
    ...
    // Redirect after save
    $http.post('/usersedit/create', useredit).success(function (data, status, headers, config) {
...
// Users controller
angular.module('users').controller('UsersController', ['$scope', '$stateParams', '$location', 'Authentication', 'UsersEdit', 'UsersFind', 'Talents', '$http', '$rootScope', '$base64', function ($scope, $stateParams, $location, Authentication, UsersEdit, UsersFind, Talents, $http, $rootScope, $base64) {
  $scope.authentication = Authentication;
  $scope.roleOpts = ['user', 'admin', 'producer/auditions director', 'auditions director', 'audio intern', 'production coordinator', 'talent director', 'client', 'client-client'];
  $scope.filter = {};
  ...
  // refresh list of users on refresh emit
  $rootScope.$on('refresh', $scope.find());
  $rootScope.$on('refreshFilter', function (event, args) {
    $scope.findFilter(args);
  });
  $scope.decodedPass = function (encodedPass) {
    var convertedPass = '';
  ...
  $scope.findTalent = function () {
    ...
    if ($scope.producerFilter === '') {
      ...
      filters = {
        'producerOptional': $scope.producerFilter
      };
    }
    $http.post('/talents/findLimitWithFilter', {
      startVal: 0,
...
angular.module('talents').factory('Talents', ['$resource', function ($resource) {
  return $resource('talents/:talentId', {
    talentId: '@_id'
  }, {
    update: {
      method: 'PUT'
...
angular.module('typecasts').factory('Typecasts', ['$resource', function ($resource) {
  return $resource('typecasts/:typecastId', {
    typecastId: '@_id'
  }, {
    update: {
      method: 'PUT'
...
// Users service used for communicating with the users REST endpoint
angular.module('users').factory('UsersEdit', ['$resource', function ($resource) {
  return $resource('usersedit/:userIdEdit', {
    userIdEdit: '@_id'
  }, {
    update: {
      method: 'PUT'
...
// Users service used for communicating with the users REST endpoint
angular.module('users').factory('UsersFind', ['$resource', function ($resource) {
  return $resource('usersfind/:userLevel', {
    userLevel: '@_id'
  }, {
    update: {
      method: 'PUT'
